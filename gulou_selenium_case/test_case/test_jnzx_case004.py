...
class Test_Login(unittest.TestCase):
    ...
    def inputinfo(self):
        # 输入考站基本信息
        XinJianKaoHe.input_createinfo(self, '规范考核-不用抽题')
    ...
    def kaozhan(self):
        ...
        KaozhanInfo.click_chouti_type(self,4)
        KaozhanInfo.click_notchouti_room(self)
        KaozhanInfo.click_nullroom(self,'4')
    ...
    def kaozhan_two(self):
        KaozhanInfo.click_notchouti_next(self)
        KaozhanInfo.send_keys_kaohename(self, '考核1')
        KaozhanInfo.click_notchouti_bingli(self)
